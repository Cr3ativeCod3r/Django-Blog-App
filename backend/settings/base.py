...
SECRET_KEY = 'django-insecure-olmf@9a8%+03ahu^lfb-8+2_3y8dc1f!lc-+485-mk&d6&k^34'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'apps' / 'pages',  # For base.html and all page templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'fchm_db'),
        'USER': os.environ.get('DB_USER', 'fchm_user'),
        'PASSWORD': os.environ.get('DB_PASSWORD', 'fchm_password'),
